...
class AddAccessoryDialog extends StatelessWidget {
    ...
    return AlertDialog(
      ...
      content: Builder(
        builder: (context) {
          ...
          AccessoryEntity accessory = AccessoryEntity();
          return SizedBox(
            //height: height - 200,
            width: width - 100,
            child: Stack(
              children: [SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Text("Zubehör hinzufügen",
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 25)),
                    Text(
                        "Erstelle ein neues Zubehör (bspw. Knöpfe, Bügelbilder) für dein Produkt und füge es deiner Kalkulation hinzu.",
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: FormBuilderDropdown(
                                  initialValue: UnitHelper.getUnitByIdentifier('stueck').identifier,
                                  onSaved: (val) {
                                    accessory.setUnit(UnitHelper
                                        .getUnitByIdentifier(
                                        val!));
                                  },
                                  name: 'unit',
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ...
                              if (formKey.currentState!
                                ...
                                dataProvider.addAccessory(accessory);
